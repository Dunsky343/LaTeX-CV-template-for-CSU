...
\newcommand{\school}{\LARGE 湘雅医学院 | XiangYa School of Medicine}

\newcommand{\contact}{
    \small
    \textcolor{white}{
        \faEnvelope \quad \href{mailto:youremail@njnu.edu.cn}{youremail@csu.edu.cn}
        \hspace{4em}
...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north, inner sep=0pt](header) at (current page.north){
            \includegraphics[width=\paperwidth]{images/csu-bg.png}
        };
        \node[anchor=west](school_logo) at (header.west){
            \hspace{0.8cm}
            \includegraphics[width=0.3\textwidth]{images/csu-long.png}
        };
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south, inner sep=0pt](footer) at (current page.south){
            \includegraphics[width=1.1\paperwidth, height=1cm]{images/csu-bg.png}
        };
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.05] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/csu.png}
        };
    \end{tikzpicture}
    ...
    \begin{minipage}[t]{0.78\textwidth}
        ...
        {\large \textbf{中南大学}}，专科 \hfill 2000年9月--2010年6月
        \begin{itemize}
            \item 你的学院，你的专业
        ...
        \vspace{0.5em}
        {\large \textbf{中南大学}}，本科 \hfill 2010年9月--2020年6月
        \begin{itemize}
            \item 你的学院，你的专业
            \item \textbf{主修课程}：课程1、课程2、课程3、课程4\ 等。
        ...
        \vspace{0.5em}
        {\large \textbf{中南大学}}，硕士 \hfill 2020年9月--至今
        \begin{itemize}
